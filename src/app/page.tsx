...
import { AiInput } from "@/components/AiChatBot";
  ...
  return (
    <div className="min-h-screen w-full bg-black relative text-white">
      <div
        ...
        style={{ background: "linear-gradient(0deg, rgba(0,0,0,0.6), rgba(0,0,0,0.6)), radial-gradient(68% 58% at 50% 50%, #2ecc71 0%, #27ae60 16%, #219653 32%, #1a7b3f 46%, #155f32 60%, #104524 72%, #0c3a1c 84%, #083013 94%, #05260a 100%), radial-gradient(90% 75% at 50% 50%, rgba(46,204,113,0.06) 0%, rgba(46,204,113,0) 55%), radial-gradient(150% 120% at 8% 8%, rgba(0,0,0,0) 42%, #0b0a0a 82%, #070707 100%), radial-gradient(150% 120% at 92% 92%, rgba(0,0,0,0) 42%, #0b0a0a 82%, #070707 100%), radial-gradient(60% 50% at 50% 60%, rgba(46,204,113,0.06), rgba(0,0,0,0) 60%), #050505" }}
      />
      <div
        ...
        <div className="flex gap-3 lg:gap-4">
          ...
          <aside className={`relative hidden lg:flex shrink-0 h-[calc(100vh-2rem)] lg:h-[calc(100vh-3rem)] rounded-lg border border-white/10 bg-white/5 p-3 flex-col transition-[width] duration-300 ${sidebarOpen ? 'w-64' : 'w-14'}`}>
            ...
            <div className={`flex items-center justify-between mb-2 ${sidebarOpen ? '' : 'opacity-0 pointer-events-none'}`}>
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-sm font-semibold">AI Fiesta</h2>
              </div>
              ...
              <div className="relative mx-3 w-full max-w-md sm:max-w-lg rounded-2xl border border-white/10 bg-zinc-900/90 p-5 shadow-2xl">
                ...
                <div className="flex flex-col sm:flex-row gap-2 justify-end mt-4">
                  <button
                    ...
                    className="text-sm px-3 py-2 rounded bg-[#2ecc71] text-white border border-white/10 hover:bg-[#27ae60]"
                  >
            ...
            {sidebarOpen ? (
              <>
                <button
                  ...
                  className="mb-3 text-sm px-3 py-2 rounded-md bg-[#2ecc71] hover:bg-[#27ae60]"
                >
                  + New Chat
                </button>
              ...
              <div className="flex-1 flex flex-col items-center pt-6">
                ...
                <button
                  ...
                  className="h-8 w-8 rounded-full bg-[#2ecc71] hover:bg-[#27ae60] flex items-center justify-center mb-4 mx-auto shrink-0"
                >
                  <Plus size={14} />
                </button>
            ...
            <div className="lg:hidden fixed inset-0 z-40">
              ...
              <div className="absolute left-0 top-0 h-full w-72 bg-zinc-900/90 border-r border-white/10 p-3">
                ...
                <button
                  ...
                  className="mb-3 text-sm px-3 py-2 w-full rounded-md bg-[#2ecc71] hover:bg-[#27ae60]"
                >
                  + New Chat
                </button>
                <div className="text-xs uppercase tracking-wide opacity-60 mb-2">Chats</div>
          ...
          <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-lg font-semibold">AI Fiesta</h1>
              </div>
              <div className="flex items-center gap-2">
                <a
                ...
                >
                  ...
                  />
                  <span className="opacity-90 hidden sm:inline text-sm">Made by <span className="font-semibold underline decoration-dotted">  Saurabh </span></span>
                </a>
                <a
                  href="https://github.com/saurabh007007"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 text-xs px-2.5 py-1 rounded bg-[#2ecc71] text-white border border-white/10 hover:bg-[#27ae60] ml-1"
            ...
            <div className="mb-3 flex items-center gap-2">
              ...
              {selectedModels.map((m) => {
                ...
                >
                  ...
                  {isUncensored && (
                    <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-emerald-500/20 text-emerald-200 ring-1 ring-emerald-300/30">
                      <span className="h-2 w-2 rounded-full bg-emerald-200" />
                      <span className="hidden sm:inline">Uncensored</span>
                    </span>
                  )}
                  <span className="truncate max-w-[180px]">{m.label}</span>
                  <span className="relative inline-flex h-4 w-7 items-center rounded-full bg-emerald-500/40">
                    <span className="h-3 w-3 rounded-full bg-emerald-200 translate-x-3.5" />
                  </span>
                </button>
              );})}
                              ...
                              return (
                                ...
                                >
                                  <span className="pr-1 inline-flex items-center gap-1.5 min-w-0">
                                    ...
                                    {unc && (
                                      <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 ring-1 ring-emerald-300/30">
                                        <span className="h-2 w-2 rounded-full bg-emerald-300" />
                                        <span className="hidden sm:inline">Uncensored</span>
                                      </span>
                                    )}
                                  ...
                                  {/* Toggle visual */}
                                  <span className={`relative inline-flex h-4 w-7 items-center rounded-full transition-colors ${selected ? 'bg-emerald-500/40' : 'bg-white/10'}`}>
                                    <span className={`h-3 w-3 rounded-full transition-transform ${selected ? 'bg-emerald-200 translate-x-3.5' : 'bg-white translate-x-0.5'}`} />
                                  </span>
                                </button>
                              );
                            })}
                      ...
                      <div key={m.id} className={`px-1 py-4 min-h-[56px] border-b flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'} overflow-visible ${m.good ? 'border-amber-300/40' : 'border-white/10'}`}>
                        ...
                        <div className="flex items-center gap-2">
                          {loadingIds.includes(m.id) && !isCollapsed && (
                            <span className="text-[11px] text-[#2ecc71]">Thinking…</span>
                          )}
                          {isCollapsed ? (
                            <button
                                ...
                                <div className={`text-sm leading-relaxed w-full pr-8 ${isCollapsed ? 'overflow-hidden max-h-20 opacity-70' : ''}`}>
                                  {ans ? (
                                    <>
                                      ...
                                      {(() => {
                                        ...
                                        <div className="mt-2">
                                          <button
                                            onClick={() => window.dispatchEvent(new Event('open-settings'))}
                                            className="text-xs px-2.5 py-1 rounded bg-[#2ecc71] text-white border border-white/10 hover:bg-[#27ae60]"
                                          >
                                            Add keys
                                          </button>
                                        </div>
                                    ...
                                    <div className="w-full self-stretch animate-pulse space-y-2">
                                      <div className="h-2.5 w-1/3 rounded bg-[#2ecc71]/30" />
